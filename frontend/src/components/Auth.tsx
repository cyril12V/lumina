    ...
    <div className="min-h-screen flex bg-[#FCFBF7] text-black">
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden bg-[#F3F2EE]">
        ...
        <div className="absolute bottom-24 left-24 max-w-sm">
          ...
          <p className="text-xs uppercase tracking-[0.4em] text-zinc-500 font-extrabold">Lumina Workspace</p>
        </div>
      </div>
          ...
          <form className="space-y-10" onSubmit={handleSubmit}>
            {mode === 'signup' && (
              <div className="group border-b-2 border-zinc-100 focus-within:border-vibrant transition-all pb-4">
                <label className="block text-[10px] uppercase tracking-widest text-vibrant mb-3 font-bold">Nom complet</label>
                <input
                  type="text"
                  value={fullName}
            ...
            <div className="group border-b-2 border-zinc-100 focus-within:border-vibrant transition-all pb-4">
              <label className="block text-[10px] uppercase tracking-widest text-vibrant mb-3 font-bold">Adresse Email</label>
              <input
                type="email"
                value={email}
            ...
            <div className="group border-b-2 border-zinc-100 focus-within:border-vibrant transition-all pb-4">
              <label className="block text-[10px] uppercase tracking-widest text-vibrant mb-3 font-bold">Mot de passe</label>
              <input
                type="password"
                value={password}
